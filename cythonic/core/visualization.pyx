...
class Plotter():
    ...
    def __init__(self, double x_lim, double y_lim, colormap = 'blue', figsize = (10,6), shown='all'):
        ...
        self.stigmergy_limits(x_lim,y_lim)
    ...
    def draw_cb(self):
        ...
        self.fig.colorbar(self.stigmergy,cax = self.ax_cb,orientation = 'vertical',pad=.1)
...
class StigmergyPlot(Plotter):
    ...
    def __init__(self, double x_lim, double y_lim, colormap = 'blue', figsize = (10,6), shown = 'all'):
        ...
        super().__init__(x_lim = x_lim, y_lim = y_lim, colormap = colormap, figsize = figsize, shown=shown)
