...
def insert_ant(sim_id, l, sens_offset, gain, noise_gain, sens_fun,deposit_fun, **kwargs):
    output = insert('ant_settings') + "(sim_id, l, sens_offset, gain, noise_gain, sens_fun,deposit_fun) "
    output += f" VALUES ({sim_id}, {l}, {sens_offset}, {gain}, {noise_gain}, '{sens_fun}','{deposit_fun}')"
    return output
